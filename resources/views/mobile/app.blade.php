...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button">
                        ...
                        <img src="{{logo()}}" width="50%" class="brand-image">
                    </a>
                </li>
        ...
        <div class="content-wrapper">
            <section class="content" style="padding:0px;background-color:black">
                @yield('content')
            </section>
        </div>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="/muvnix/plugins/jquery-ui/jquery-ui.min.js"></script>
    <!-- Bootstrap 4 -->
