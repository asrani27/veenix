            ...
            <tbody>
              ...
              <tr style="font-size: 14px">
                ...
                <td class="text-center"><a href="{{$item->link_video}}" class="btn btn-primary" target="_blank"><i
                      class="fa fa-play"></i> {{$item->quality}}</a>
                  <br /><br />
                ...
                <td>
                  <a href="/superadmin/post/edit/{{$item->id}}" class="btn btn-sm btn-success"><i
                      class="fa fa-edit"></i></a>
                  <a href="/superadmin/post/delete/{{$item->id}}" class="btn btn-sm btn-danger"
