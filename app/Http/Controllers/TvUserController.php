...
class TvUserController extends Controller
{
    ...
    {
        $data = Tv::where('username', Auth::user()->username)->orderBy('id', 'DESC')->paginate(10);
    ...
    public function edit($id)
    {
        ...
        return view('user.tv.edit', compact('data'));
    }
    ...
    public function editEpisode($id)
    {
        ...
        return view('user.tv.editepisode', compact('data'));
    }
    public function updateEpisode(Request $req, $id)
    {
        ...
        return redirect('/user/tv/episode/' . $tv_id);
    }
    ...
    public function episode($id)
    {
        ...
        return view('user.tv.episode', compact('data', 'episode'));
    }
